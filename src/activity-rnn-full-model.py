...
if __name__ == '__main__':
	...
	if soc.gethostname()[:6] == "yzpc":
		...
		checkpointPath = '/home/yz/human_anticipation_data/checkpoint1'
	...
	#path_to_checkpoints = '{1}/checkpoints/full_model_{0}'.format(fold,main_path)
	path_to_checkpoints = '{1}/full_model_{0}'.format(fold, checkpointPath)
