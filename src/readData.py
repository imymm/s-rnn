...
def sortActivities(folder):
	...
	ground_truth='/home/yz/human_anticipation_data/CAD_120/features_cad120_ground_truth_segmentation/features_binary_svm_format'
	#dataset = '/home/yz/human_anticipation_data/CAD_120/features_cad120_ground_truth_segmentation/dataset/fold_{0}'.format(fold)
	dataset = '/home/yz/human_anticipation_data/CAD_120/features_cad120_ground_truth_segmentation/dataset2/fold_{0}'.format(fold)
	...
	all_the_files = listdir(folder)   #返回指定文件夹的名字的列表

	all_activities = []
	activities_time_steps = {}
	for f in all_the_files:
		s = f.split('_')[0]   #通过指定的分隔符对字符串进行切片
...
if __name__ == '__main__':
	...
	for fold in folds:	
		...
		s = '/home/yz/human_anticipation_data/CAD_120/features_cad120_ground_truth_segmentation/features_binary_svm_format'
		test_file = '/home/yz/human_anticipation_data/CAD_120/features_cad120_ground_truth_segmentation/segments_svm_format/fold{0}.txt'.format(fold)
		...
		for j in folds:
			if j == fold:
				continue
			train_file = '/home/yz/human_anticipation_data/CAD_120/features_cad120_ground_truth_segmentation/segments_svm_format/fold{0}.txt'.format(j)
