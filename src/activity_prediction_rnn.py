...
def predict_activitiy(index,fold,checkpoint):
	...
	#path_to_dataset = '/home/yz_pc/windowsE/features_cad120_ground_truth_segmentation/dataset1/{0}'.format(fold)
	#path_to_checkpoints = '/home/yz_pc/windowsE/features_cad120_ground_truth_segmentation/checkpoints/fold_1'

	path_to_dataset = '/home/yz/human_anticipation_data/CAD_120/features_cad120_ground_truth_segmentation/dataset1/{0}'.format(fold)
	path_to_checkpoints = '/home/yz/human_anticipation_data/CAD_120/features_cad120_ground_truth_segmentation/checkpoints1/fold_1'
